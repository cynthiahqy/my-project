...
```{r, echo=FALSE}
source("code/viz-country-concord/edges.R")
edges
```
...
labelled sigmoid plot: [code](code/viz-country-concord/ggbump-sigmoid-graph-edges.R)
...
```
![](plots/viz-country-concord/ggbump-sigmoid-graph-edges.jpg)

sankey flow diagram using `{ggsankey}`: [code](code/viz-country-concord/ggsankey.R)

![sankey flow diagram](plots/viz-country-concord/ggsankey.png) 

alluvial plot using `{ggalluvial}`: [code](code/viz-country-concord/ggalluvial.R)

![alluvial plot](plots/viz-country-concord/ggalluvial.png){width="445"}
