...
## CH: normalize with range method scales numeric data to given scale
fine_data <- tibble(fine_cap = BBmisc::normalize(rank(sdf$price_cap), range = c(40.12161, 66.12161), method = "range"),
                    country = sdf$admin,
                    x_axis_start = 70,
                    # xend = 60,
